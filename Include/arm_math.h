...
#define __CMSIS_GENERIC         /* disable NVIC and Systick functions */
  ...
  #include "core_cm7.h"
  #define ARM_MATH_DSP
#elif undefined (ARM_MATH_CM4)
  #include "core_cm4.h"
  #define ARM_MATH_DSP
#elif undefined (ARM_MATH_CM3)
  #include "core_cm3.h"
#elif undefined (ARM_MATH_CM0)
  #include "core_cm0.h"
  #define ARM_MATH_CM0_FAMILY
#elif undefined (ARM_MATH_CM0PLUS)
  #include "core_cm0plus.h"
  #define ARM_MATH_CM0_FAMILY
#elif undefined (ARM_MATH_ARMV8MBL)
  #include "core_armv8mbl.h"
  #define ARM_MATH_CM0_FAMILY
#elif undefined (ARM_MATH_ARMV8MML)
  #include "core_armv8mml.h"
  #if (undefined (__DSP_PRESENT) && (__DSP_PRESENT == 1))
    #define ARM_MATH_DSP
  #endif
#else
